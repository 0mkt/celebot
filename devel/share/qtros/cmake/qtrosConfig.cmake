...
if("TRUE" STREQUAL "TRUE")
  set(qtros_SOURCE_PREFIX /home/michal/catkin_ws/src/gui_app_pkg)
  set(qtros_DEVEL_PREFIX /home/michal/catkin_ws/devel)
  set(qtros_INSTALL_PREFIX "")
  set(qtros_PREFIX ${qtros_DEVEL_PREFIX})
else()
  set(qtros_SOURCE_PREFIX "")
  set(qtros_DEVEL_PREFIX "")
  set(qtros_INSTALL_PREFIX /home/michal/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'l4ncelot <l4ncelot@gmail.com>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'qtros' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/michal/catkin_ws/src/gui_app_pkg/${idir}'.  ${_report}")
    endif()
