...
class SCNChangeStateServiceMsgRequest {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type SCNChangeStateServiceMsgRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type SCNChangeStateServiceMsgRequest
    let len;
    let data = new SCNChangeStateServiceMsgRequest(null);
  ...
  static datatype() {
    ...
    return 'custom_msg_pkg/SCNChangeStateServiceMsgRequest';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new SCNChangeStateServiceMsgRequest(null);
...
class SCNChangeStateServiceMsgResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
      this.result = null;
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type SCNChangeStateServiceMsgResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type SCNChangeStateServiceMsgResponse
    let len;
    let data = new SCNChangeStateServiceMsgResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new SCNChangeStateServiceMsgResponse(null);
...
module.exports = {
  Request: SCNChangeStateServiceMsgRequest,
  Response: SCNChangeStateServiceMsgResponse,
  md5sum() { return 'e7cf3a237ea1ba28a266b276ffbdbbae'; },
  datatype() { return 'custom_msg_pkg/SCNChangeStateServiceMsg'; }
};
