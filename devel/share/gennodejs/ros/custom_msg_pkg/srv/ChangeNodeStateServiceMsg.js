...
class ChangeNodeStateServiceMsgRequest {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type ChangeNodeStateServiceMsgRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type ChangeNodeStateServiceMsgRequest
    let len;
    let data = new ChangeNodeStateServiceMsgRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new ChangeNodeStateServiceMsgRequest(null);
...
class ChangeNodeStateServiceMsgResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
      this.result = null;
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type ChangeNodeStateServiceMsgResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type ChangeNodeStateServiceMsgResponse
    let len;
    let data = new ChangeNodeStateServiceMsgResponse(null);
  ...
  static datatype() {
    // Returns string type for a service object
    return 'custom_msg_pkg/ChangeNodeStateServiceMsgResponse';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ChangeNodeStateServiceMsgResponse(null);
...
module.exports = {
  Request: ChangeNodeStateServiceMsgRequest,
  Response: ChangeNodeStateServiceMsgResponse,
  md5sum() { return 'e7cf3a237ea1ba28a266b276ffbdbbae'; },
  datatype() { return 'custom_msg_pkg/ChangeNodeStateServiceMsg'; }
};
