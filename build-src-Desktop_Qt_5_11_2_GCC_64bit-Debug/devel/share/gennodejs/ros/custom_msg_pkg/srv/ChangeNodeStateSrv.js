...
class ChangeNodeStateSrvRequest {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type ChangeNodeStateSrvRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type ChangeNodeStateSrvRequest
    let len;
    let data = new ChangeNodeStateSrvRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new ChangeNodeStateSrvRequest(null);
...
class ChangeNodeStateSrvResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
      this.result = null;
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type ChangeNodeStateSrvResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type ChangeNodeStateSrvResponse
    let len;
    let data = new ChangeNodeStateSrvResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new ChangeNodeStateSrvResponse(null);
...
module.exports = {
  Request: ChangeNodeStateSrvRequest,
  Response: ChangeNodeStateSrvResponse,
  md5sum() { return 'e7cf3a237ea1ba28a266b276ffbdbbae'; },
  datatype() { return 'custom_msg_pkg/ChangeNodeStateSrv'; }
};
