...
public:
    ...
    void setupUi(QMainWindow *MainWindowDesign)
    {
        ...
        label_servo_1_alarm = new QLabel(formLayoutWidget);
        label_servo_1_alarm->setObjectName(QStringLiteral("label_servo_1_alarm"));
        label_servo_1_alarm->setAlignment(Qt::AlignCenter);

        formLayout_servo_1->setWidget(3, QFormLayout::FieldRole, label_servo_1_alarm);
    ...
    void retranslateUi(QMainWindow *MainWindowDesign)
    {
        ...
        label_servo_1_alarm->setText(QApplication::translate("MainWindowDesign", "n/a", Q_NULLPTR));
